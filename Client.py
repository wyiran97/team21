...
port = int(sys.argv[4])
size = int(sys.argv[6])
print("[Checkpoint 01] Connecting to: " + sys.argv[2] + " on port " + sys.argv[4])
...
class MyStreamListener(tweepy.StreamListener):
    def on_status(self,status):
        ...
        print("[Checkpoint 04] Encrypt: Generated Key: " + key.decode() + "| Cipher text: " + cipher_text.decode())
        payload_tuple = (key, cipher_text, checksum)
        print("[Checkpoint 05] Sending data: ")
        print(payload_tuple)
        ...
        print("[Checkpoint 06] Received data: ")
        print(data_unpickle)
        ...
        print("[Checkpoint 07] Decrypt: Using Key: " + data_unpickle[0].decode() + "| Plain text: " + plain_answer.decode())
        ...
        mixer.music.play()
        print("[Checkpoint 08] Speaking Answer: " + plain_answer.decode())
        time.sleep(5)
